  ...
  for (const dimension of dimensions) {
    ...
    if (!applicable) {
      ...
      fieldEvaluations.push({
        ...
        points: 0,
        reason: `Not clinically required for ${profile.name}.`,
      });
      scoreBreakdown.push({
        dimension: dimension.label,
        points: 0,
        explanation: `Not clinically required for ${profile.name}.`,
      });
      matchedReferenceFields.push(
        `${dimension.label} (not required for ${profile.name})`,
      );
      drivers.push({
        factor: dimension.label,
        impact: "neutral",
        points: 0,
        explanation: `Scored against the applicable ${profile.name} evidence, not an inpatient-only field set.`,
      });
      ...
      fieldEvaluations.push({
        ...
        status: "COMPLETE",
        points: 1,
        reason: "Clear, relevant, and sufficiently complete.",
      });
      scoreBreakdown.push({
        dimension: dimension.label,
        points: 1,
        explanation: "Present, clear, and sufficiently consistent.",
      });
      ...
      drivers.push({
        ...
        impact: "positive",
        points: 1,
        explanation: "Evidence is present and sufficiently specific.",
      });
      ...
      fieldEvaluations.push({
        ...
        status: "MISSING",
        points: 0,
        reason: "No usable evidence was extracted.",
      });
      scoreBreakdown.push({
        dimension: dimension.label,
        points: 0,
        explanation: "Missing or unreadable.",
      });
      drivers.push({
        factor: dimension.label,
        impact: "negative",
        points: 0,
        explanation: "Expected evidence was not found.",
      });
    }
  }
